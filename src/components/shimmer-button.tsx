  ...
  (
    ...
    return (
      ...
      >
        ...
        <span className="relative z-30 inline-flex items-center justify-center font-inherit text-inherit opacity-100">{children}</span>
        <div className={cn("pointer-events-none absolute inset-0 z-10 size-full", "rounded-2xl px-4 py-1.5 text-sm font-medium shadow-[inset_0_-8px_10px_#ffffff1f]", "transform-gpu transition-all duration-300 ease-in-out", "group-hover:shadow-[inset_0_-6px_10px_#ffffff3f]", "group-active:shadow-[inset_0_-10px_10px_#ffffff3f]")} />
